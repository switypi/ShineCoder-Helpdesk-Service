...
{
    /// <inheritdoc />
    public partial class _160120241 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ticket_Impacts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ticket_Urgencies", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5273), "Low impact ticket", null, null, "Low", "" },
                    { 2, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5276), "High impact ticket", null, null, "High", "" },
                    { 3, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5279), "Normal impact ticket", null, null, "Normal", "" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5208), "Low priority ticket", null, null, "Low", "" },
                    { 2, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5212), "High priority ticket", null, null, "High", "" },
                    { 3, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5214), "Medium priority ticket", null, null, "Medium", "" },
                    { 4, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5216), "Normal priority ticket", null, null, "Normal", "" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(4987), "New ticket", null, null, "New", "" },
                    { 2, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5002), "Open ticket", null, null, "Open", "" },
                    { 3, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5006), "Closed ticket", null, null, "Closed", "" },
                    { 4, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5009), "Resolved ticket", null, null, "Resolved", "" },
                    { 5, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5011), "Assigned ticket", null, null, "Assigned", "" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5238), "Low Urgency", null, null, "Low", "" },
                    { 2, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5241), "High urgency", null, null, "High", "" },
                    { 3, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5243), "Normal urgency", null, null, "Normal", "" },
                    { 4, true, "admin", new DateTime(2024, 1, 16, 14, 50, 10, 562, DateTimeKind.Local).AddTicks(5245), "Urgent", null, null, "Urgent", "" }
                });
